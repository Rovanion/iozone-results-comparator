...
class Plotter:
    ...
    def summary(self, Base, Set1, ops):
        ...
        # Base[3] - mins
        # Base[4] - maxes
        ax.errorbar(x1,Base[1],yerr=[numpy.array(Base[1]) - numpy.array(Base[3]),numpy.array(Base[4]) - numpy.array(Base[1])],color='black',linestyle='None',marker='None')
        ...
        rects1 = ax.bar(x,numpy.array(Base[1]) - numpy.array(Base[0]),width,bottom=Base[0],color='white')
        ax.bar(x,numpy.array(Base[2]) - numpy.array(Base[1]),width,bottom=Base[1],color='white')

        # set1 bars
        rects2 = ax.bar(x+width,numpy.array(Set1[1]) - numpy.array(Set1[0]),width,bottom=Set1[0],color='red')
        ax.bar(x+width,numpy.array(Set1[2]) - numpy.array(Set1[1]),width,bottom=Set1[1],color='red')
